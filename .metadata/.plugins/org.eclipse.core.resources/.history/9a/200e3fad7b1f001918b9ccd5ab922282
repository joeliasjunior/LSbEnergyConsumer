...
#ifndef __INET_LSBEnergyConsumer_H
#define __INET_LSBEnergyConsumer_H
 ...
 */
class INET_API LSBEnergyConsumer : public cSimpleModule, public IEnergyConsumer
{
  protected:
    bool isSleeping;
    int energyConsumerId;
    IEnergySource *energySource;
    W powerConsumption = W(100);
    //cMessage *timer;
...
#endif // ifndef __INET_LSBEnergyConsumer_H
